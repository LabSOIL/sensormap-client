...
class Gnss(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["comment", "coord_srid", "coord_x", "coord_y", "data_base64", "elevation_gps", "filename", "id", "last_updated", "latitude", "longitude", "name", "original_filename", "time"]
