...
class SoilProfile(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["area_id", "aspect", "coord_srid", "coord_x", "coord_y", "coord_z", "created_on", "description_horizon", "gradient", "id", "last_updated", "lythology_surficial_deposit", "name", "parent_material", "photo", "soil_diagram", "soil_type_id", "topography", "vegetation_type", "weather"]
