...
class InstrumentExperimentCreate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["data_source", "date", "description", "device_filename", "filename", "init_e", "instrument_model", "name", "project_id", "quiet_time", "run_time", "sample_interval", "samples", "sensitivity"]
