...
class InstrumentExperimentChannelUpdate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["baseline_chosen_points", "baseline_spline", "baseline_values", "channel_name", "experiment_id", "integral_chosen_pairs", "integral_results", "raw_values", "time_values"]
