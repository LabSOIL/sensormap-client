...
class ClosestSensorProfile(BaseModel):
    """
    ClosestSensorProfile
    """ # noqa: E501
    distance: Union[StrictFloat, StrictInt]
    elevation_difference: Union[StrictFloat, StrictInt]
    id: StrictStr
    name: StrictStr
    __properties: ClassVar[List[str]] = ["distance", "elevation_difference", "id", "name"]
