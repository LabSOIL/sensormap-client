...
class TestSensorProfileAssignmentCreate(unittest.TestCase):
    """SensorProfileAssignmentCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SensorProfileAssignmentCreate:
        """Test SensorProfileAssignmentCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SensorProfileAssignmentCreate`
        """
        model = SensorProfileAssignmentCreate()
        if include_optional:
            return SensorProfileAssignmentCreate(
                data = [
    ...
    def testSensorProfileAssignmentCreate(self):
        """Test SensorProfileAssignmentCreate"""
