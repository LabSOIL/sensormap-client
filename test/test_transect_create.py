...
class TestTransectCreate(unittest.TestCase):
    """TransectCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransectCreate:
        """Test TransectCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransectCreate`
        """
        model = TransectCreate()
        if include_optional:
            return TransectCreate(
                area_id = '',
                description = '',
                name = '',
                nodes = [
