...
class TestSensorProfileAssignment(unittest.TestCase):
    """SensorProfileAssignment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SensorProfileAssignment:
        """Test SensorProfileAssignment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SensorProfileAssignment`
        """
        model = SensorProfileAssignment()
        if include_optional:
            return SensorProfileAssignment(
                data = [
    ...
    def testSensorProfileAssignment(self):
        """Test SensorProfileAssignment"""
