...
class TestTransectNode(unittest.TestCase):
    """TransectNode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransectNode:
        """Test TransectNode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransectNode`
        """
        model = TransectNode()
        if include_optional:
            return TransectNode(
